...
/**
 * This is a converter that is able to read and write
 * <code>Geometry2DAdapter</code> objects using their well- known- text (WKT)
 * representation. This textual representation is writen to a binary Stream
 * using a {@link StringConverter}.
 * 
 * <p>Example usage (1).
 * <code><pre>
 ...
 *   // create a Geometry 
 *   xxl.connectivity.jts.Point2DAdapter geometry0 = xxl.connectivity.jts.Geometry2DFactory.createPoint(5,5,false);
 *          
 ...
 * </pre></code></p>
 * 
 * @see Geometry2DAdapter#toWKT()
 * @see Geometry2DFactory#createFromWKT(String, PrecisionModel)
 * @see xxl.core.io.converters.Converter
 * @see xxl.core.io.converters.StringConverter
 * @see DataInput
 * @see DataOutput
 * @see IOException 
 */
public class WKTGeometryConverter extends Converter<Geometry2DAdapter> {
	 ...
	 */
	public static WKTGeometryConverter DEFAULT_INSTANCE = new WKTGeometryConverter();


	/**
	 *  Creates a new WKTGeometryConverter- instance	 
	 */
	private WKTGeometryConverter(){};

	/**
	 * Restores the <code>Geometry2DAdapter</code> object from its WKT- representation 
	 * from the stream.
	 * 
	 * A {@link StringConverter} is used to restore the objects wkt- representation from  
	 * the stream.
	 * 
	...
	public Geometry2DAdapter read(DataInput dataInput, Geometry2DAdapter object) throws IOException {
		...
		object = Geometry2DFactory.createFromWKT(StringConverter.DEFAULT_INSTANCE.read(dataInput),p);
		object.setSRID(SRID);
		return object;
	}

	/**
	 * Writes the WKT- representation of the given <code>Geometry2DAdapter</code> object
	 * to the specified data output.
	 * 
	 * This implementation uses a {@link StringConverter} to write the WKT- representation
	 * to the stream
	 * 
	 * @param dataOutput the stream to write the WKT- representation of the <code>Geometry2DAdapter</code> 
	 *        object to.
	 * @param object the <code>Geometry2DAdapter</code> object whose WKT- representation
	...
	public void write(DataOutput dataOutput, Geometry2DAdapter object) throws IOException {		
		...
		StringConverter.DEFAULT_INSTANCE.write(dataOutput, object.toWKT());		
	}
}
