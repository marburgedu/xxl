 ...
 * @see IOException
 */
public class Geometry2DConverter extends Converter<Geometry2DAdapter> {
	 ...
	 */
	public static Geometry2DConverter DEFAULT_INSTANCE = new Geometry2DConverter();
		
	/**
	 *  Creates a new Geometry2DConverter- instance	 
	 */
	protected Geometry2DConverter(){};
