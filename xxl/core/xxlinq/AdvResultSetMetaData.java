...
public class AdvResultSetMetaData extends ColumnMetaDataResultSetMetaData {
	...
	// Spezialfall: Cursorn über pseudo-primitive Datentypen ist der name standardmäßig "value"
	// gibt logischen index im zugehörigen tupel zurück (wie man ihn mit getObject() nutzen würde)
	...
	// klasse, die 2 strings enthält: für alias und name, soll als schlüssel der aliasName2index-hashmap dienen
	static class AliasName { // FIXME: hierfür gibts irgendne fertige xxl-klasse
		String alias=null;
		String name=null;
		...
		// sinnvolle vergleichsfunktion, macht sich sicher gut fürs mapping...
		@Override
	...
	public static ColumnMetaData createColumnMetaData(final Class<?> cl, final String name, final String alias){
		...
		return new ColumnMetaData() {
			...
			public boolean isSearchable() throws SQLException {
				return true; // grundsätzlich sollte erstmal alles in ner where-clause gehen
