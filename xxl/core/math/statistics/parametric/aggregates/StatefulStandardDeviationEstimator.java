 ...
 * using {@link xxl.core.math.statistics.parametric.aggregates.StatefulVarianceEstimator}.
 * <br>
 ...
 */
public class StatefulStandardDeviationEstimator extends AggregationFunction<Number, Number> {

	/** internally used Function for recursive computing of internally used variance */
	protected StatefulVarianceEstimator var;
	 ...
	 */
	public StatefulStandardDeviationEstimator() {
		var = new StatefulVarianceEstimator();
	}
	 ...
	 * status and the next given object as an object of type <tt>Number</tt>).
	 */
	@Override
